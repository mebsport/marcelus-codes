...
const ProjectCard = (props: ProjectCardProps) => {
  return (
    <div>
      ...
      >
        <div className='overlay absolute top-0 left-0 w-full h-full bg-[#181818] bg-opacity-0  hidden grid-cols-2 group-hover:grid group-hover:bg-opacity-80 transition-all duration-500'>
